...
|---|---|---|---|
| FEAT-20260602-001 | `workflow_run_id` on `Message` + every `comm.*` event payload (Comm sibling of the [Cross umbrella](../../../CodeValdCross/documentation/3-SofwareDevelopment/mvp-details/FEAT-20260602-001_workflow_run_id_propagation_umbrella.md)) | 📋 Not Started | FEAT-20260602-001 in CodeValdFunctions (start-pipeline) |
